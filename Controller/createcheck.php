...
include "../Model/dbChecklistInsert.php";
...
<head>
    ...
    <link rel="stylesheet" href="../View/css/createcheck.css"></link>
    <script src="../View/js/createcheck.js"></script>
</head>
<body>
...
<br>
    ...
    <p align="right"><a href="../View/checklist.php">Back</ap>
